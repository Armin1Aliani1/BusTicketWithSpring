...
<div id="user-login">
    ...
    <br><br>
    <form:form action="userLogin" modelAttribute="passenger">
        <form:input id="tuu" path="userName"/><br>
        <form:password id="ppu" path="password"/><br>
    ...
    <a href="passengerSignup"><small>don't have an account? signup</small></a>
</div>
